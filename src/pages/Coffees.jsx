...
export default function Coffees() {
  ...
  if (loading) return <LoadingScreen>Loading coffees...</LoadingScreen>;
  if (error) return <ErrorScreen>Error loading coffees</ErrorScreen>;
  ...
  return (
    <Container>
      ...
      <Hero>
        ...
        <HeroContent>
          <SimplyClever>OUR MENU</SimplyClever>
          <BestCoffee>ALL COFFEES</BestCoffee>
          <HeroSubtext>Discover our handcrafted selection</HeroSubtext>
        </HeroContent>
      </Hero>
      ...
      <MainContent>
        <SectionHeader>
          <SectionTitle>All Coffees</SectionTitle>
